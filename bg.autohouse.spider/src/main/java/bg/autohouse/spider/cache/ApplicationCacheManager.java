...
public class ApplicationCacheManager implements AutoCloseable
{
    ...
    public ApplicationCacheManager()
    {
        ...
        this.cacheManager = CacheManagerBuilder.newCacheManagerBuilder()
                ...
                .withCache(buildName("makers"), CacheConfigurationBuilder.newCacheConfigurationBuilder(String.class, MakersModelsWrapper.class,
                        ResourcePoolsBuilder.newResourcePoolsBuilder().disk(2, MemoryUnit.MB, true))
                )
                .withCache(buildName("maker_models"), CacheConfigurationBuilder.newCacheConfigurationBuilder(String.class, ModelsCarsWrapper.class,
    ...
    {
        return this.cacheManager.getCache(buildName("maker_models"), String.class, ModelsCarsWrapper.class);
    }
