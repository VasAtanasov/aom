package bg.autohouse.backend.feature.common.model.dao;

import bg.autohouse.backend.feature.common.car.dao.Car;
import bg.autohouse.util.common.persistance.BaseEntity;
import bg.autohouse.util.common.persistance.ColumnConstants;
import bg.autohouse.backend.feature.common.maker.dao.Maker;
import bg.autohouse.backend.feature.common.model.validation.ModelName;
...
import static bg.autohouse.backend.feature.common.model.dao.Model.ENTITY_NAME;
import static bg.autohouse.backend.domain.validation.ValidationMessages.MAKER_NULL;
