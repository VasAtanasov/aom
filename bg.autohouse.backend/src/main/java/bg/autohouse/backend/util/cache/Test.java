...
import bg.autohouse.backend.util.cache.adaptors.ehcache.EhcacheDiskCacheAdapter;
import bg.autohouse.backend.util.cache.adaptors.ehcache.EhcacheHeapCacheAdapter;
