...
import static bg.autohouse.backend.validation.ValidationMessages.MAKER_NAME_BLANK;
import static bg.autohouse.backend.validation.ValidationMessages.MAKER_NAME_LENGTH;
