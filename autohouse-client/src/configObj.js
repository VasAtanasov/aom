export default {
    ...
    "metadata": {
        ...
        "fuelTypes": [
            { id: "fuelType.gasoline", name: "Gasoline", count: 0 },
            { id: "fuelType.diesel", name: "Diesel", count: 0 },
            { id: "fuelType.ethanol", name: "Ethanol", count: 0 },
            { id: "fuelType.electric", name: "Electric", count: 0 },
            { id: "fuelType.hydrogen", name: "Hydrogen", count: 0 },
            { id: "fuelType.lpg", name: "LPG", count: 0 },
            { id: "fuelType.cng", name: "CNG", count: 0 },
            { id: "fuelType.electric_gasoline", name: "Electric/Gasoline", count: 0 },
            { id: "fuelType.electric_diesel", name: "Electric/Diesel", count: 0 },
            { id: "fuelType.others", name: "Others", count: 0 },
        ],
        "transmissionTypes": [
            {
                "id": 1,
        ...
        "assignment100pc": [
            {
                "id": true,
                "name": "highAssignment.only"
            }
        ],
        "isCarOnStock": [
            {
                "id": true,
                "name": "carOnStock.only-TBD"
            }
        ],
        "vatRegimes": [
            {
                "id": false,
                "name": "vatRegime.vatExclusive"
            },
            {
                "id": true,
                "name": "vatRegime.vatNonDeductable"
            }
        ]
    },
    "searching": false,
