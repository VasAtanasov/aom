...
public class ExceptionsMessages {
  ...
  public static final String USER_NOT_FOUND_ID = "No user was found with provided id!";
  public static final String ACCOUNT_NOT_FOUND = "No account was found for user!";
  public static final String USER_NOT_FOUND_USERNAME = "No user was found with provided username!";
